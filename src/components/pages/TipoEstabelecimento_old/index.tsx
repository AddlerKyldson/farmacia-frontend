...
const TipoEstabelecimento: React.FC = () => {
    ...
    return (
        <Layout>
            ...
            <Breadcrumb paginas={[{ texto: "Home", href: '/' }, { texto: "Tipos de Estabelecimento" }]} />

            <Titulo titulo="Tipos de Estabelecimento" botao={{ texto: "Cadastrar", href: "/tipos-estabelecimentos/form" }} />
